    ...
    return (
      <div className="p-8 max-w-4xl space-y-6">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 glass rounded-xl border border-[--border] h-64 shimmer" />
          <div className="glass rounded-xl border border-[--border] h-48 shimmer" />
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="p-8 max-w-4xl">
      ...
      <AdminPageHeader
        ...
        description={`${inquiry.inquiryType.replace(/_/g, ' ')} · ${new Date(inquiry.createdAt).toLocaleString()}`}
      />
      ...
      <div className="grid lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {/* Notes */}
          <div className="glass rounded-xl p-6 border border-[--border]">
            <h2 className="kicker text-[--text-muted] mb-4">Internal Notes</h2>
            ...
            <form onSubmit={submitNote} className="flex gap-2">
              ...
              <button type="submit" disabled={addingNote || !note.trim()}
                className="btn-cinematic btn-primary px-3 py-2 rounded-full disabled:opacity-50">
                <Send size={15} />
              </button>
            </form>
          </div>
        ...
        <div className="space-y-4">
          <div className="glass rounded-xl p-5 border border-[--border]">
            <h2 className="kicker text-[--text-muted] mb-4">Update Status</h2>
          ...
          {inquiry.assignedTo && (
            <div className="glass rounded-xl p-5 border border-[--border]">
              <h2 className="kicker text-[--text-muted] mb-2">Assigned To</h2>
